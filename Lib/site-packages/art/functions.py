...
from .params import (
    ART_ENVIRONMENT_WARNING,
    FONT_ENVIRONMENT_WARNING,
    FONT_OR_DECOR_ENVIRONMENT_WARNING,
)
from .params import (
    DECORATION_TYPE_ERROR,
    TEXT_TYPE_ERROR,
    FONT_TYPE_ERROR,
    CHR_IGNORE_TYPE_ERROR,
    FILE_TYPE_ERROR,
)
from .params import (
    PRINT_STATUS_TYPE_ERROR,
    OVERWRITE_TYPE_ERROR,
    SEP_TYPE_ERROR,
    SPACE_TYPE_ERROR,
)
from .params import (
    DETAILED_RETURN_TYPE_ERROR,
    ART_TYPE_ERROR,
    NUMBER_TYPE_ERROR,
    ART_NAME_ERROR,
)
...
def tprint(
    text, font=DEFAULT_FONT, chr_ignore=True, decoration=None, sep="\n", space=0
):
    r"""
    ...
    try:
        if font == "UnicodeEncodeError":
            raise UnicodeEncodeError("test", "", 42, 43, "test unicode-encode-error")
